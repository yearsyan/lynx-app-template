...
static NSString *const kEventName = @"nativeWebSocket";
...
@interface NativeWebSocketModule () <NSURLSessionWebSocketDelegate>
@end
...
@LynxNativeModule("NativeWebSocketModule")
