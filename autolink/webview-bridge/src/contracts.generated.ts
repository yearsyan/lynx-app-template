...
export const NATIVE_MODULE_CONTRACT = {
  ...
  Device: {
    ...
    methods: {
      ...
      openAppSettings: { name: 'openAppSettings', arity: 1 },
  ...
  Navigation: {
    ...
    methods: {
      ...
      canOpenURL: { name: 'canOpenURL', arity: 2 },
...
export const NATIVE_MODULE_METHODS = {
  ...
  Device: {
    ...
    openAppSettings: NATIVE_MODULE_CONTRACT.Device.methods.openAppSettings.name,
  ...
  Navigation: {
    ...
    canOpenURL: NATIVE_MODULE_CONTRACT.Navigation.methods.canOpenURL.name,
