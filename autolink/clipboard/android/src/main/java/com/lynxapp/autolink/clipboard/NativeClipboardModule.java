...
@LynxNativeModule(name = NativeClipboardModule.NAME)
public class NativeClipboardModule extends LynxContextModule {
    public static final String NAME = "NativeClipboardModule";
    private static final String CLIP_LABEL = "lynx.clipboard";

    public NativeClipboardModule(LynxContext context) {
        super(context);
    }
