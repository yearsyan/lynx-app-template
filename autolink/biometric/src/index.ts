/**
 * Autolinked system biometric prompt for Lynx hosts on Android and iOS.
 *
 * The native module registers itself as `Biometric`, so bundles
...
export const BIOMETRIC_MODULE_NAME = 'Biometric';
